...
# load the data
trainning_data = pd.read_csv('TrainingDataBinary.csv', header=None)
...
testing_feature = testing_data.iloc[:, :128]
y_test_pred = grid_search.best_estimator_.predict(testing_feature)
